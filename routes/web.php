<?php
    ...
    */
    ...
    Route::get('/hakkimizda', [App\Http\Controllers\frontController::class, 'about'])->name('about');
    ...
    Route::get('/odullerimiz', [App\Http\Controllers\frontController::class, 'awards'])->name('awards');
